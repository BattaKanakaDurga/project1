...
private static WebElement element = null;
	...
	//Method For System Admin
	 ...
	 try
 		{
		 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class='navbar navbar-default mx-navbar mx-name-menuBar2 hidden-xs']/ul/li[5]/a")));
 		}
 	catch(Exception e){
 	...
 	//Method For Renewal Testing
 	 ...
 	 //Method For Search Button At Traditional Renewal
 		 ...
 		 try
 	 		{
 			 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class='btn mx-button btn-default mx-name-search mx-grid-search-button']")));
 	 		}
 	 	catch(Exception e){
 	 		System.out.println(e);
 	 	}
		 ...
		 try
	 		{
			 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@Class='btn mx-button mx-name-actionButton6 btn-default']")));
	 		}
	 	catch(Exception e){
	 		System.out.println(e);
	 	}
		 ...
		 try
	 		{
			 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class='mx-name-formatString1']/div/h4")));
	 		}
	 	catch(Exception e){
	 		System.out.println(e);
	 	}
		 ...
		 try
	 		{
			 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@Class='nav nav-tabs mx-tabcontainer-tabs']/li[8]/a")));
	 		}
	 	catch(Exception e){
	 		System.out.println(e);
	 	}
		 ...
		 try
	 		{
			 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class='nav nav-tabs mx-tabcontainer-tabs']/li[3]/a")));
	 		}
	 	catch(Exception e){
	 		System.out.println(e);
	 	}

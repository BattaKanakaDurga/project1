...
private static WebElement element = null;
	...
	//Method For State	 
	 ...
	 try
 		{
		 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[@Class='mx-referenceselector-input-wrapper']/select)[1]")));
 		}
 	catch(Exception e){
 	...
 	return element;
		...
		//Method For Profession	 
		 ...
		 try
	 		{
			 element= fwait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class = 'mx-name-container14 form__element']//div//select")));
	 		}
	 	catch(Exception e){
	 		System.out.println(e);
	 	}
